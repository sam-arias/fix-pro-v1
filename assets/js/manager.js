      ...
      <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <div class="dropdown">
          <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span id="currentPeriod">Últimos 30 días</span>
          </button>
      ...
      <div class="col-md-3">
        <div class="card stat-card bg-primary text-white">
          <div class="card-body">
            ...
            <h2 class="card-stat">$${(salesData.monthlySummary.reduce((sum, month) => sum + month.sales, 0)).toLocaleString()}</h2>
...
/**
 * Calcula el crecimiento porcentual de ventas
 */
...
/**
 * Inicializa el gráfico de ventas por categoría
 */
...
/**
 * Cambia el período de visualización de ventas
...
function changeSalesPeriod(period) {
  document.getElementById('currentPeriod').textContent = 
    ...
    period === 'year' ? 'Este año' : 'Últimos 30 días';
  
  // Aquí iría la lógica para cargar datos del período seleccionado
  showAlert('Período cambiado', `Mostrando datos de ${document.getElementById('currentPeriod').textContent}`, 'info');
}

/**
 * Muestra el modal para seleccionar rango de fechas personalizado
 */
...
function applyCustomDateRange() {
  ...
  // Aquí iría la lógica para cargar datos del rango seleccionado
...
function viewTransactionDetails(transactionId) {
  ...
  // Simulamos detalles de la transacción
...
/**
 * Imprime los detalles de la transacción
 */
function printTransaction() {
  // En una implementación real, aquí se prepararía la vista para impresión

      ...
      <div class="col-md-3">
        <div class="card stat-card bg-warning text-white">
          <div class="card-body">
            ...
            <h2 class="card-stat">${salesData.recentTransactions.filter(transaction => transaction.status === 'Pendiente').length}</h2>
          </div>
        </div>
      </div>
      <div class="col-md-3">
    ...
    <div class="row mb-4">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <ul class="list-group">
              <li class="list-group-item">Orden #1245 actualizada por Juan Pérez</li>
              <li class="list-group-item">Nueva orden creada por María García</li>
              <li class="list-group-item">Inventario actualizado: Pantalla iPhone 12</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-danger text-white">
            <h5>Notificaciones Importantes</h5>
          </div>
          <div class="card-body">
            <ul class="list-group">
              <li class="list-group-item">Orden #1243 está atrasada</li>
              <li class="list-group-item">Inventario bajo: Batería Samsung S21</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body d-flex justify-content-around">
            <button class="btn btn-primary" onclick="showOrderForm()">Nueva Orden</button>
            <button class="btn btn-secondary" onclick="showInventory()">Ver Inventario</button>
            <button class="btn btn-success" onclick="showTechnicians()">Gestión de Técnicos</button>
          </div>
        </div>
      </div>
    </div>
...
const salesData = {
  ...
  byCategory: [
    { category: 'Pantallas', percentage: 42 },
    { category: 'Baterías', percentage: 25 },
    { category: 'Software', percentage: 15 },
    { category: 'Accesorios', percentage: 11 },
    { category: 'Herramientas', percentage: 6 }
  ],
  recentTransactions: [
    { id: 10045, date: '2023-06-15', client: 'María González', status: 'Completada' },
    { id: 10044, date: '2023-06-14', client: 'Carlos Mendoza', status: 'Completada' },
    { id: 10042, date: '2023-06-13', client: 'Roberto Sánchez', status: 'Completada' },
    { id: 10041, date: '2023-06-12', client: 'Ana López', status: 'Pendiente' }
  ]
};
...
function calculateGrowth() {
  ...
  if (months.length < 9) return 0;
  
  const current = months[months.length - 1].orders;
  const previous = months[months.length - 2].orders;
